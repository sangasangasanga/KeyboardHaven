<div id="bannder_Slider" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <!-- Next and Previous -->
  <a class="carousel-control-prev" href="#bannder_Slider" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#bannder_Slider" role="button" data-slide="next">
